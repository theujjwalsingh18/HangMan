...
function Home() {
    ...
    async function fetchWords() {
        try {
            ...
            setHintText(data[randomIdx].wordHint);
        } catch (error) {
                        ...
                        <div className="p-4 sm:p-6 space-y-3 sm:space-y-4">
                            ...
                            >
                                <div className="text-center">
                                    ...
                                    <h3 className="text-lg sm:text-xl font-bold text-cyan-400 mb-1 sm:mb-2">Single Player</h3>
                                    <p className="text-gray-300 text-xs sm:text-sm">Play against the computer. Test your vocabulary skills alone.</p>
                                </div>
                            </div>
